process PRODIGAL {
    ...
    // modify with -p meta flag for inputting metagenomic assemblies
    // -m flag to skip over non-sequence characters
    // indidvidual pigz or else tries to zip the original fasta again which is a symbolic link
