process SOURMASH_COMPARE {
    ...
    // updated version number and seqtype input for distinguishing between reads and assemblies
    ...
    def comp   = save_numpy_matrix ? "--output ${seqtype}.comp.npy"  : ''
    def csv    = save_csv          ? "--csv ${seqtype}.comp.csv" : ''
